...
class ExtensionHelper {
	...
	static String createForm(title, validationFailedMessage, fields, postback, buttonText, button){
		def result = ""
		def elements = [:]
		elements.put("title", title)
		elements.put("validationFailedMessage", validationFailedMessage)
		elements.put("openFormButtonText", buttonText)
		elements.put("postback", postback)
